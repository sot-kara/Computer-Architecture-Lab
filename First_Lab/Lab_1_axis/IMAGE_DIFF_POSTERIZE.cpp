...
void IMAGE_DIFF_POSTERIZE(hls::stream<wide_t> &stream_A, 
    ...
    #pragma HLS ARRAY_PARTITION variable=buf_A type=complete dim=2
    #pragma HLS ARRAY_PARTITION variable=buf_B type=complete dim=2
    #pragma HLS ARRAY_PARTITION variable=buf_C type=complete dim=2
